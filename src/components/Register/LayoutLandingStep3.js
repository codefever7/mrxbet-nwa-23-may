...
export default class LayoutLandingStep3 extends Component {
            ...
            <Row className="body step-body-3 justify-content-center">
                ...
                <Col md={10} xs={12} className="mt-5 mb-5">
                    <Row className="justify-content-center">
                        <Col xs={6}>
                            <Button className="w-100 btn-next btn-1 d-flex justify-content-center" type="button" onClick={() => nextStep(2)}>
