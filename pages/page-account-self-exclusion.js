...
import SelfExclusion from '../src/components/Account/SelfExclusion'
...
class index extends Component {
    ...
    render() {
        ...
        const componentRender = session.isLogin ? <SelfExclusion /> : <PageNoLogin title={locale.t('selfExclusion')} />
        return (
            <Fragment>
