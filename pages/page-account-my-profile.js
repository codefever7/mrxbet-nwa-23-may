...
class index extends Component {
    ...
    render() {
        ...
        const { menu, isMobile, isLoadData, loading } = this.state
        const componentRenderMenu = session.isLogin ? <Profile placement='menuleft' /> : <PageNoLogin title={locale.t('profile')} />
        const componentRender = session.isLogin ? <Profile  placement='profile' /> : <PageNoLogin title={locale.t('profile')} />
        return (
            <Fragment>
                                ...
                                <Container className="container-custom">
                                    <Row>
                                        <Col lg={3} md={12} xs={12}>
                                            <Menu {...this.props} {...this.state} menu={menu} componentRender={componentRenderMenu} />
                                        </Col>
