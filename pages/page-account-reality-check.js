...
import RealityCheck from '../src/components/Account/RealityCheck'
...
class index extends Component {
    ...
    render() {
        ...
        const componentRender = session.isLogin ? <RealityCheck /> : <PageNoLogin title={locale.t('realityCheck')} />
        return (
            <Fragment>
